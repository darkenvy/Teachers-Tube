                ...
                function plyr() {
                    ...
                    (function (root, factory) {
                        ...
                        function _extend() {
                            ...
                            var destination = Array.prototype.shift.call(objects), length = objects.length;
                        ...
                        function Plyr(media, config) {
                            ...
                            var _log = function () { _console('log', arguments); }, _warn = function () { _console('warn', arguments); };
                            // Log config options
                            _log('Config', config);
                            // Get icon URL
                            ...
                            function _buildControls() {
                                // Create html array
                                var html = [], iconUrl = _getIconUrl(), iconPath = (!iconUrl.absolute ? iconUrl.url : '') + '#' + config.iconPrefix;
                            ...
                            function _setupCaptions() {
                                ...
                                var captionSrc = '', kind, children = plyr.media.childNodes;
                                                ...
                                                if (xhr.readyState === 4) {
                                                    if (xhr.status === 200) {
                                                        ...
                                                        for (var r = 0; r < captions.length; r++) {
                                                            ...
                                                            var parts = caption.split(lineSeparator), index = 0;
                            ...
                            function _setCaption(caption) {
                                /* jshint unused:false */
                                var container = _getElement(config.selectors.captions), content = document.createElement('span');
                                // Empty the container
                                container.innerHTML = '';
                                // Default to empty
                            ...
                            function _focusTrap() {
                                var tabbables = _getElements('input:not([disabled]), button:not([disabled])'), first = tabbables[0], last = tabbables[tabbables.length - 1];
                            ...
                            function _setupEmbed() {
                                var container = document.createElement('div'), mediaId, id = plyr.type + '-' + Math.floor(Math.random() * (10000));
                            ...
                            function _seek(input) {
                                var targetTime = 0, paused = plyr.media.paused, duration = _getDuration();
                                if (_is.number(input)) {
                                    targetTime = input;
                                }
                            ...
                            function _setVolume(volume) {
                                var max = config.volumeMax, min = config.volumeMin;
                            ...
                            function _updateSeekTooltip(event) {
                                ...
                                var clientRect = plyr.progress.container.getBoundingClientRect(), percent = 0, visible = config.classes.tooltip + '--visible';
                            ...
                            function _controlListeners() {
                                ...
                                function togglePlay() {
                                    ...
                                    var trigger = plyr.buttons[play ? 'play' : 'pause'], target = plyr.buttons[play ? 'pause' : 'play'];
                                ...
                                if (config.keyboardShorcuts.focused) {
                                    ...
                                    if (config.keyboardShorcuts.global) {
                                        _on(window, 'keydown keyup', function (event) {
                                            var code = getKeyCode(event), focused = getFocusElement(), allowed = [48, 49, 50, 51, 52, 53, 54, 56, 57, 75, 77, 70, 67], count = get().length;
                                ...
                                function handleKey(event) {
                                    var code = getKeyCode(event), pressed = event.type === 'keydown', held = pressed && code === last;
                                ...
                                _on(window, 'keyup', function (event) {
                                    var code = getKeyCode(event), focused = getFocusElement();
                                    if (code === 9) {
                                ...
                                _on(plyr.volume.input, 'wheel', function (event) {
                                    ...
                                    var inverted = event.webkitDirectionInvertedFromDevice, step = (config.volumeStep / 5);
                        ...
                        function supported(type) {
                            var browser = _browserSniff(), isOldIE = (browser.isIE && browser.version <= 9), isIos = browser.isIos, isIphone = browser.isIphone, audioSupport = !!document.createElement('audio').canPlayType, videoSupport = !!document.createElement('video').canPlayType, basic = false, full = false;
                            switch (type) {
                                case 'video':
                                    basic = videoSupport;
                        ...
                        function setup(targets, options) {
                            // Get the players
                            var players = [], instances = [], selector = [defaults.selectors.html5, defaults.selectors.embed].join(',');
                            // Select the elements
                            ...
                            players.forEach(function (player) {
                                var element = player.target, media = player.media, match = false;
                        ...
                        function get(container) {
                            ...
                            if (_is.htmlElement(container)) {
                                var elements = container.querySelectorAll('.' + defaults.classes.setup), instances = [];
